...
// Variable Font demo component (educational / demo use)
...
const TextPressure = ({
    ...
    // ⚠️ demo font – commercial project-д ашиглахгүй
    fontUrl =
    ...
    return (
        ...
        >
            ...
            <h1
                ref={titleRef}
                className={`uppercase text-center ${flex ? "flex justify-between" : ""
                    } ${stroke ? "text-pressure-stroke" : ""} ${className}`}
                style={{
                    fontFamily,
                    fontSize,
                    lineHeight,
